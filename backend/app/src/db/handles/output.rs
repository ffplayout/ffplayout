...
pub async fn update_output_on(
    ...
    const QUERY: &str = "UPDATE config_output SET hls_variants = $3, stream_url = $4, stream_type = $5, stream_format = $6, hls_playlist_name = $7, hls_segment_duration = $8, hls_list_size = $9, desktop_fullscreen = $10, width = $11, height = $12, fps = $13, video_codec = $14, video_options = $15, muxer_options = $16, audio_codec = $17, audio_options = $18, audio_bitrate = $19 WHERE id = $1 AND config_id = (SELECT id FROM config WHERE channel_id = $2)";
