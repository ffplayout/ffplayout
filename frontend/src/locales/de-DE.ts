export default {
    ...
    config: {
        ...
        outputHelp: `Die endgültige Playout-Codierung, passe die Einstellungen nach deinen Bedürfnissen an. Verwende den 'stream'-Modus und setze die Ziel-URL, wenn du zu einem RTMP/RTSP/SRT/...-Server streamen möchtest. Im Produktionsbetrieb verwende kein HLS mit ffplayout; nutze Nginx oder einen anderen Webserver!`,
        outputParam: 'HLS-Segment- und Playlist-Pfade sind relativ.',
        streamUrl: 'Stream-Ziel-URL',
        hlsSettings: 'HLS-Einstellungen',
        hlsPlaylistPath: 'Playlist-Pfad',
        ...
        hlsVariantsHelp: 'Füge adaptive Bitraten-Varianten für die HLS-Ausgabe hinzu. Eine Master-Playlist mit allen Varianten wird automatisch erstellt. Leer lassen für einen einzelnen Stream.',
