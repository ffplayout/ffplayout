export default {
    ...
    player: {
        ...
        audio: 'Audio',
        audioSourcePlaceholder: 'Optionale separate Audiodatei oder URL',
    ...
    config: {
        ...
        audio: 'Audio',
        recording: 'Aufnahme',
        recordingEnable: 'Aufnahme aktivieren',
        recordingSource: 'Quelle',
        recordingCurrentStream: 'Aktuelle Stream-Ausgabe',
        recordingHlsVariant: 'HLS-Variante',
        recordingEncode: 'Eigene Aufnahme-Kodierung',
        recordingSourceOutput: 'Quellausgabe',
        recordingSelectOutput: 'Ausgabe auswählen',
        recordingWidth: 'Breite (0 = Ausgabebreite)',
        recordingHeight: 'Höhe (0 = Ausgabehöhe)',
        recordingPath: 'Aufnahmepfad',
        recordingSegmentDuration: 'Segmentdauer (Sekunden)',
        recordingRetention: 'Aufbewahrung (Tage, 0 = unbegrenzt)',
        ...
        outputParam: 'Die Media-Playlist wird als live/<Name>.m3u8 erzeugt.',
        streamUrl: 'Stream-Ziel-URL',
        hlsSettings: 'HLS-Einstellungen',
        hlsPlaylistName: 'Playlist-Name',
        outputFormat: 'Ausgabeformat',
        hlsSegmentDuration: 'Segmentdauer (Sekunden)',
        hlsListSize: 'Playlist-Größe',
        hlsSubtitleName: 'Untertitelname',
    ...
    setup: {
        ...
        loadFailed: 'Die Anfangseinstellungen konnten nicht geladen werden.',
        passwordMismatch: 'Die Passwörter stimmen nicht überein.',
        saveFailed: 'Die Einrichtung konnte nicht abgeschlossen werden.',
    },
    user: {
