export default {
    ...
    config: {
        ...
        hlsVariantsHelp: 'Add adaptive bitrate renditions for HLS output. A master playlist referencing all variants is generated automatically. Leave empty for a single stream.',
