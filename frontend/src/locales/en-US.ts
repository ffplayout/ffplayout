export default {
    ...
    config: {
        ...
        audio: 'Audio',
        recording: 'Recording',
        recordingEnable: 'Enable recording',
        recordingSource: 'Source',
        recordingCurrentStream: 'Current stream output',
        recordingHlsVariant: 'HLS variant',
        recordingEncode: 'Dedicated recording encode',
        recordingSourceOutput: 'Source output',
        recordingSelectOutput: 'Select output',
        recordingWidth: 'Width (0 = output width)',
        recordingHeight: 'Height (0 = output height)',
        recordingPath: 'Recording path',
        recordingSegmentDuration: 'Segment duration (seconds)',
        recordingRetention: 'Retention (days, 0 = unlimited)',
        ...
        hlsSegmentDuration: 'Segment duration (seconds)',
        hlsListSize: 'Playlist size',
        hlsSubtitleName: 'Subtitle name',
        ...
        protocolOptions: 'Output protocol options',
        protocolOptionsHelp:
            'Transport options used when opening an RTMP, SRT, UDP, or supported custom network output. Examples: SRT latency=2000000 or UDP pkt_size=1316. Values, including passphrases, are stored and returned unchanged. ffplayout-managed timeouts cannot be overridden.',
        addProtocolOption: 'Add protocol option',
        protocolOptionName: 'Option name',
        protocolOptionValue: 'Value',
    ...
    setup: {
        ...
        loadFailed: 'Unable to load the initial settings.',
        passwordMismatch: 'Passwords do not match.',
        saveFailed: 'Unable to complete the setup.',
    },
    user: {
