export default {
    ...
    control: {
        ...
        navigationDisabledLive: 'A navegação da playlist está desativada durante a ingestão ao vivo.',
    ...
    config: {
        ...
        audio: 'Áudio',
        recording: 'Gravação',
        recordingEnable: 'Ativar gravação',
        recordingSource: 'Fonte',
        recordingCurrentStream: 'Saída de stream atual',
        recordingHlsVariant: 'Variante HLS',
        recordingEncode: 'Codificação dedicada para gravação',
        recordingSourceOutput: 'Saída de origem',
        recordingSelectOutput: 'Selecionar saída',
        recordingWidth: 'Largura (0 = largura da saída)',
        recordingHeight: 'Altura (0 = altura da saída)',
        recordingPath: 'Caminho da gravação',
        recordingSegmentDuration: 'Duração do segmento (segundos)',
        recordingRetention: 'Retenção (dias, 0 = ilimitada)',
        ...
        outputParam: 'A playlist de mídia é criada como live/<nome>.m3u8.',
        streamUrl: 'URL de destino do stream',
        hlsSettings: 'Configurações HLS',
        hlsPlaylistName: 'Nome da playlist',
        outputFormat: 'Formato de saída',
        hlsSegmentDuration: 'Duração do segmento (segundos)',
        hlsListSize: 'Tamanho da playlist',
        hlsSubtitleName: 'Nome da legenda',
        hlsSubtitleLanguage: 'Idioma da legenda',
        hlsSubtitleDefault: 'Legenda padrão',
        encodingSettings: 'Configurações do codificador',
        audioEncoderOptions: 'Opções avançadas do codificador de áudio',
        audioEncoderOptionsHelp:
            'Opções adicionais do FFmpeg para o codificador de áudio selecionado. Configurações gerenciadas pelo ffplayout não podem ser substituídas; nomes ou valores não suportados são rejeitados ao salvar.',
        addAudioOption: 'Adicionar opção de áudio',
        audioOptionName: 'Nome da opção',
        audioOptionValue: 'Valor',
        protocolOptions: 'Opções do protocolo de saída',
        protocolOptionsHelp:
            'Opções de transporte usadas ao abrir uma saída de rede RTMP, SRT, UDP ou personalizada compatível. Exemplos: SRT latency=2000000 ou UDP pkt_size=1316. Os valores, incluindo frases secretas, são armazenados e retornados sem alterações. Os timeouts gerenciados pelo ffplayout não podem ser substituídos.',
        addProtocolOption: 'Adicionar opção de protocolo',
        protocolOptionName: 'Nome da opção',
        protocolOptionValue: 'Valor',
    ...
    setup: {
        ...
        loadFailed: 'Não foi possível carregar as configurações iniciais.',
        passwordMismatch: 'As senhas não coincidem.',
        saveFailed: 'Não foi possível concluir a configuração.',
    },
    user: {
