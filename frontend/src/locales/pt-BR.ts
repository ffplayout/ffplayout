export default {
    ...
    config: {
        ...
        hlsPlaylistPath: 'Caminho da playlist',
        ...
        hlsVariantsHelp: 'Adicione variantes de taxa de bits adaptável para a saída HLS. Uma playlist master referenciando todas as variantes é gerada automaticamente. Deixe vazio para um único stream.',
