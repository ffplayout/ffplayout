export default {
    ...
    config: {
        ...
        hlsPlaylistPath: 'Путь к плейлисту',
        ...
        hlsVariantsHelp: 'Добавьте адаптивные битрейт-варианты для вывода HLS. Мастер-плейлист со ссылками на все варианты создаётся автоматически. Оставьте пустым для одного потока.',
