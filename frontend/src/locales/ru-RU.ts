export default {
    ...
    config: {
        ...
        notificationTopic: 'Тема',
        notificationLevel: 'Минимальный уровень',
        ...
        audio: 'Аудио',
        recording: 'Запись',
        recordingEnable: 'Включить запись',
        recordingSource: 'Источник',
        recordingCurrentStream: 'Текущий потоковый выход',
        recordingHlsVariant: 'Вариант HLS',
        recordingEncode: 'Отдельное кодирование записи',
        recordingSourceOutput: 'Исходный выход',
        recordingSelectOutput: 'Выберите выход',
        recordingWidth: 'Ширина (0 = ширина выхода)',
        recordingHeight: 'Высота (0 = высота выхода)',
        recordingPath: 'Путь записи',
        recordingSegmentDuration: 'Длительность сегмента (секунды)',
        recordingRetention: 'Хранение (дни, 0 = без ограничений)',
        recordingMinimumFreeSpace: 'Минимум свободного места (ГБ, 0 = отключено)',
        recordingUpdated: 'Конфигурация записи обновлена',
        placeholderPass: 'Password',
        placeholderToken: 'Токен',
        help: 'Help',
        generalHelp:
